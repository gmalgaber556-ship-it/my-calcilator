...
/**
 * Modern Elegant Calculator Component - Full Screen Vertical
      ...
      <div className="w-full h-full flex flex-col bg-white">
        ...
        <div className="flex-1 p-4 space-y-2 overflow-hidden bg-white flex flex-col">
          ...
          <div className="grid grid-cols-4 gap-2 flex-shrink-0">
            <button
              onClick={handleClear}
              className="col-span-2 bg-red-500 hover:bg-red-600 text-white font-bold text-lg py-3 rounded-lg transition-all duration-200 active:scale-95 shadow-lg hover:shadow-xl"
            >
              مسح
            </button>
            <button
              onClick={handleBackspace}
              className="bg-orange-500 hover:bg-orange-600 text-white font-bold text-lg py-3 rounded-lg transition-all duration-200 active:scale-95 shadow-lg hover:shadow-xl flex items-center justify-center"
            >
              <Delete size={24} />
            </button>
            <button
              onClick={() => handleSpecialOperation('negate')}
              className="bg-slate-400 hover:bg-slate-500 text-white font-bold text-2xl py-3 rounded-lg transition-all duration-200 active:scale-95 shadow-lg hover:shadow-xl"
            >
              ±
            </button>
          </div>
          ...
          <div className="grid grid-cols-4 gap-2 flex-shrink-0">
            <button
              ...
              className="bg-purple-500 hover:bg-purple-600 text-white font-bold text-xl py-3 rounded-lg transition-all duration-200 active:scale-95 shadow-lg hover:shadow-xl"
            >
              √
            </button>
            <button
          ...
          <div className="grid grid-cols-4 gap-2 flex-shrink-0">
            <button
              ...
              className="bg-slate-200 hover:bg-slate-300 text-slate-900 font-bold text-xl py-3 rounded-lg transition-all duration-200 active:scale-95 shadow-md hover:shadow-lg"
            >
              7
            </button>
            <button
            ...
            <button
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white font-bold text-2xl py-3 rounded-lg transition-all duration-200 active:scale-95 shadow-lg hover:shadow-xl"
            >
              ÷
            </button>
          </div>
          ...
          <div className="grid grid-cols-4 gap-2 flex-shrink-0">
            <button
              ...
              className="col-span-2 bg-slate-200 hover:bg-slate-300 text-slate-900 font-bold text-xl py-3 rounded-lg transition-all duration-200 active:scale-95 shadow-md hover:shadow-lg"
            >
              0
            </button>
            <button
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold text-2xl py-3 rounded-lg transition-all duration-200 active:scale-95 shadow-lg hover:shadow-xl flex-shrink-0"
          >
            =
          </button>
        </div>
